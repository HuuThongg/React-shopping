                ...
                <div className="relative pl-4 pr-0">
                  ...
                  <div className="relative  min-h-[275px] ">
                    ...
                    >
                      {/* each carousel item */}
                      {/* w-[20.3125%] */}
                      <div className="  my-1 mr-[10px] ml-1 flex  min-h-[280px] w-[145px] flex-none basis-auto snap-align-none hover:outline hover:outline-2 hover:outline-offset-2 hover:outline-black screen600:min-h-[386px] screen600:w-[235px] screen960:min-h-[400px] screen960:w-[235px] screen1280:w-[260px] screen1600:w-[16%]">
                    ...
                    {/* prev button */}
                    <button
                      className="text-[25px]p-2 absolute top-[50px] left-1 z-50 flex w-[30px] h-[30px]  screen600:h-[50px] screen600:w-[50px] items-center justify-center rounded-sm border-[3px] border-solid  border-slate-400 bg-white screen600:top-[120px]"
                    ...
                    {/* next button */}
                    <button
                      className="absolute right-0 top-[50px] z-50 flex w-[30px] h-[30px]  screen600:h-[50px] screen600:w-[50px]
                      items-center justify-center rounded-sm border-[3px] border-solid border-slate-400 bg-white p-2 text-[25px] screen600:top-[120px]"
