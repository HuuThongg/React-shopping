            ...
            <div className="flex w-full flex-wrap items-center px-0">
              <div className="ml-[33.33333%] w-[66.666667%] ">
                <div className="flex  justify-end">
                  ...
                  <div className="inline-flex items-center">
                    <span class="ml-1">8AM ET – 11PM ET, 7 days a week</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="flex w-full flex-wrap">
          ...
          <div className="w-full px-0 screen1280:ml-[4.1666666667%] ">
            <div className="relative flex w-full ">
              <Link to="/" className="mr-5 flex py-[15px]">
              ...
              <div to="/" className="mr-5 flex py-[15px]">
                <div className="items-self-center flex h-6 w-6 justify-self-center rounded-full bg-black pl-2 text-sm font-bold text-white">
                  2
                </div>
          ...
          <main className="w-full  px-0 screen960:w-[58.3333333%] screen1280:ml-[4.1666666667%]">
            <div className="mt-[40px] flex w-full flex-wrap ">
            ...
            <div className="-ml-[10px] flex w-full flex-wrap ">
              <div className="grow-1 m-[10px]  flex max-w-[calc(50%-20px)] shrink-0 basis-[34%] bg-red-200">
                <div className="grow-1 flex min-h-[12rem] w-full flex-col border border-black p-5">
                  <div className="grow-1 flex flex-col overflow-hidden ">
                    <strong className="w-full font-bold "> Huu Thong Le</strong>
                    <div className="mt-4 text-base font-normal leading-[22px]">
                      <div>1565 Ovene</div>
