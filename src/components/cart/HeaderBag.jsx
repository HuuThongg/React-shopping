...
const HeaderBag = ({ amountItems, totalAmount }) => {
  ...
  if(amountItems!==0){
    ...
    content= <header className="float-right flex w-full px-0 ">
      <div className="flex flex-col flex-wrap">
        <div className="mt-3 max-w-[729px] text-[20px] font-bold uppercase">
          <h5 className=" w-full pb-[50px] pt-[30px]">Hello THONG</h5>
        </div>
        ...
        <a
          href="#"
          className=" checkoutShadow  relative inline-flex min-h-[50px] w-[170px] cursor-pointer  items-center justify-between whitespace-nowrap border-none  px-[15px] text-left bg-black text-white"
        >
