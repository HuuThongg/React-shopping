...
const OverlayFilter = () => {
  ...
  return (
    <div className=" z-[150] hidden screen960:block">
      <div
        className={`opacityTransistion ${isToggleFilter ? "visible opacity-100" : "invisible opacity-0"
          }  fixed inset-0  z-[150] w-full cursor-pointer bg-[#0003]   `}
      >
        {/* filter panel desktop */}
        {/* unset */}
        <div
          className={`scrollbar-hide fixed top-0 ${isToggleFilter ? "right-0" : "-right-[30%]"
