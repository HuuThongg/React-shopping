...
const Content = () => {
  ...
  const { data: product, error, isLoading } = useSWR(`https://api.npoint.io/412448615c4faa493df3/` + (+id! - 1).toString(), fetcher)
  if (isLoading) return <div className="h-full min-h-screen w-full min-w-0">
    {/* gallery-section */}
