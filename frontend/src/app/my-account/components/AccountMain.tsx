...
import Order from "../order-history/OrderHisotry";
import OrderHisotry from "../order-history/OrderHisotry";
const AccountMain = () => {
      ...
      >
        ...
        <div className=" sticky top-0 z-[96] m-0 w-full bg-white p-0">
          <div className="relative flex w-full items-center justify-center ">
            <button
              className={`mb-[5px] mr-2 flex shrink-0 cursor-pointer overflow-hidden text-ellipsis ${tab === 1 && "border-b-[3px]  border-solid border-black"
            ...
            <button
              className={`mb-[5px] mr-2 flex shrink-0 cursor-pointer overflow-hidden text-ellipsis ${tab === 2 && "border-b-[3px]  border-solid border-black"
                } bg-white p-[15px] text-center text-sm font-bold uppercase leading-5 tracking-normal text-black opacity-100 transition-colors`}
              onClick={() => {
                setTab(2);
              }}
            ...
            <button
              className={`mb-[5px] mr-2 flex shrink-0 cursor-pointer overflow-hidden text-ellipsis ${tab === 3 && "border-b-[3px]  border-solid border-black"
                } bg-white p-[15px] text-center text-sm font-bold uppercase leading-5 tracking-normal text-black opacity-100 transition-colors`}
              onClick={() => {
                setTab(3);
              }}
