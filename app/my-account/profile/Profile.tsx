...
const Profile = () => {
  ...
  return (
    <section
      className={`relative z-[1] pt-[95px]  md:pt-[100px] bg-[#f7f7f7] `}
    >
      <div className="">
        <Tab />
      </div>
                      ...
                      <div>
                        ...
                        <div className="relative min-h-[84px] w-full overflow-visible  ">
                          ...
                          >
                            ...
                            <fieldset
                              className={`pointer-events-none absolute left-0 bottom-0 m-0 h-full  w-full rounded-lg border border-solid  ${isTouchedRegion
                                ? "border-[#757575]"
                                : "border-[#dcdcdc]"
                                }  p-0  `}
                            >
                        ...
                        <div className="relative min-h-[84px] w-full overflow-visible">
                          ...
                          <div className="relative flex h-[56px] w-full flex-col items-center justify-start rounded-lg border-orange-600 bg-transparent bg-red-100 ">
                            ...
                            <label
                              className={`absolute left-2 top-4 scale-100 px-1 text-base leading-6 transition-all delay-[250] ease-[cubic-bezier(0.25,0.1,0.25,0.1)] ${isTouchedProvince
                                ? "origin-center -translate-y-[28px] -translate-x-[10px] scale-75 text-[#131313] "
                                : "text-[#979494]"
                                } pointer-events-none`}
                            >
                              <span
                                className={`${errors.province ? "text-[#d43f21]" : ""
                                  }`}
                              >
                                Province
                              </span>
                            ...
                            <fieldset
                              className={`pointer-events-none absolute left-0 bottom-0 m-0 h-full  w-full rounded-lg border border-solid  ${isTouchedProvince
                                ? "border-[#757575]"
                                : "border-[#dcdcdc]"
                                }  p-0 ${errors.province ? "border-[#d43f21]" : ""
                                }`}
                            >
                              <legend
                                className={`invisible ml-[7px] h-[1px] px-1 py-0 text-[12px] transition-all delay-[250] ease-[cubic-bezier(0.25,0.1,0.25,0.1)]
                        ...
                        <div className="relative min-h-[84px] w-full overflow-visible">
                          ...
                          <div className="relative flex h-[56px] w-full flex-col items-center justify-start rounded-lg border-orange-600 bg-transparent bg-red-100 ">
                            ...
                            <label
                              className={`absolute left-2 top-4 scale-100 px-1 text-base leading-6 transition-all delay-[250] ease-[cubic-bezier(0.25,0.1,0.25,0.1)] ${isTouchedCity
                                ? "origin-center -translate-y-[28px] -translate-x-[10px] scale-75 text-[#131313] "
                                : "text-[#979494]"
                                } pointer-events-none`}
                            >
                              <span
                                className={`${errors.city ? "text-[#d43f21]" : ""
                                  }`}
                              >
                                City
                              </span>
                            ...
                            <fieldset
                              className={`pointer-events-none absolute left-0 bottom-0 m-0 h-full  w-full rounded-lg border border-solid  ${isTouchedCity
                                ? "border-[#757575]"
                                : "border-[#dcdcdc]"
                        ...
                        <div className="relative min-h-[84px] w-full overflow-visible">
                          ...
                          <div className="relative flex h-[56px] w-full flex-col items-center justify-start rounded-lg border-orange-600 bg-transparent bg-red-100 ">
                            ...
                            <label
                              className={`absolute left-2 top-4 scale-100 px-1 text-base leading-6 transition-all delay-[250] ease-[cubic-bezier(0.25,0.1,0.25,0.1)] ${isTouchedPostCode
                                ? "origin-center -translate-y-[28px] -translate-x-[10px] scale-75 text-[#131313] "
                                : "text-[#979494]"
                                } pointer-events-none`}
                            >
                              <span
                                className={`${errors.postcode && "text-[#d43f21]"
                                  }`}
                              >
                                Postcode*
                              </span>
                            ...
                            <fieldset
                              className={`pointer-events-none absolute left-0 bottom-0 m-0 h-full  w-full rounded-lg border border-solid  ${isTouchedPostCode
                                ? "border-[#757575]"
                                : "border-[#dcdcdc]"
                                }  p-0 ${errors.postcode ? "border-[#d43f21]" : ""
                                }`}
                            >
                              <legend
                                className={`invisible ml-[7px] h-[1px] px-1 py-0 text-[12px] transition-all delay-[250] ease-[cubic-bezier(0.25,0.1,0.25,0.1)]
